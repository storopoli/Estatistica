...
Geralmente no R você pode ~~*plotar*~~ motrar graficamente diversos objetos com o comando `plot()`. Quando você *plota* um *dataset* (conjunto de dados lido de um aquivo), o R retorna um gráfico chamado *Pair Plot*:
