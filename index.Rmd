...
2. [Teste de Hipóteses e Teste $t$](2-Teste_t.html)
3. [Análise de Variância (ANOVA)](3-ANOVA.html)
4. [Correlações](4-Correlacoes.html)
5. [Regressão Linear](5-Regressao_Linear.html)
6. [Regressão Logística](6-Regressao_Logistica.html)
