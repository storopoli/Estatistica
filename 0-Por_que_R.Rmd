...
Além disso, com a biblioteca `{rmarkdown}` e seus diversos *templates*, é possível autorar diversos tipos de documentos[^13]:
...
A ciência está passando por uma crise de credibilidade que no fundo é também uma crise de replicabilidade. Dê o seu código em R e os seus dados para qualquer um e a análise e estatísticas serão as mesmas.

Claro que R não soluciona todo o problema de replicabilidade da ciência. Mas, código aberto, e se possível, dados abertos, já ajudam bastante...
