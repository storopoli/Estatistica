...
Além de computarmos o valor da correlação entre duas variáveis, é possível também realizar um teste estatístico de hipótese nula sobre a correlação de duas variáveis. **A hipótese nula $H_0$ nesse caso é de que "as variáveis possuem correlação iguala a zero"**.
