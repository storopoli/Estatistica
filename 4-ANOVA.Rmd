...
Podemos ver que o comprimento dos dentes `len` não muda conforme o método de entrega da dosagem `supp` (suco de laranja vs ácido ascórbico).
...
Porém, o comprimento dos dentes `len` muda conforme o tamanho da dose `dose` (0.5, 1.0 ou 2.0 mg).
